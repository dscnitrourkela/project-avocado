...
const List<String> sectionArray = ["P1","P2","P3","P4","P5","P6","P7","P8","P9","P10"];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Text("Select your practical section",
                            style: TextStyle(
                              fontSize: 24,
                              fontWeight: FontWeight.w500,
                              fontFamily: 'PfDin',
...
Widget _buildCarousel(
    _PracticalSectionState timetableState, BuildContext context, int carouselIndex) {
  return Column(
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      SizedBox(
...
Widget _buildCarouselItem(BuildContext context, int carouselIndex, int itemIndex, double SizeScale, double ColorScale) {
  return Container(
    alignment: Alignment.center,
    child: Text(
