          ...
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                ...
                contactCard(context, "Achint Sarbajeet Bishoyi", "Student Coordinator", "+91 8917378986"),
                contactCard(context, "Amrit Jena", "Student Coordinator", "+91 9658636724"),
                contactCard(context, "Armandev Puhan", "Student Coordinator", "+91 7077176080"),
                contactCard(context, "Dakarapu Rishi", "Student Coordinator", "+91 9938776163"),
                contactCard(context, "Ekta Sharma", "Student Coordinator", "+91 8093620228"),
                ...
                contactCard(context, "Nihar Ranjan Mohanty", "Student Coordinator", "+91 8658596698"),
                contactCard(context, "Ritika Agrawal", "Student Coordinator", "+91 8249138790"),
                contactCard(context, "Seema Priyanka", "Student Coordinator", "+91 7327859870"),
            ...
            Column(
              children: <Widget>[
                contactCard(context, "Amartya Avizeeta", "Prefect", "+91 9090865543"),
                contactCard(context, "Ayush Sinha", "Prefect", "+91 8106408226"),
                contactCard(context, "Boddepalli Ramya", "Prefect", "+91 9490688623"),
                contactCard(context, "Priyanka Kumari", "Prefect", "+91 9668397133"),
                contactCard(context, "Shubhra Pujari", "Prefect", "+91 8249664693"),
                contactCard(context, "Simran Deep Singh Thakral", "Prefect", "+91 8349307179"),
                contactCard(context, "Sufyan Khan", "Prefect", "+91 9583665111"),
                contactCard(context, "Suman Acharya", "Prefect", "+91 7008013067"),
                contactCard(context, "Supreet Mohanty", "Prefect", "+91 8895420701"),
                contactCard(context, "Sushree Samapika", "Prefect", "+91 7377939397"),
                contactCard(context, "Swapnil Sahoo", "Prefect", "+91 8895112417"),
                contactCard(context, "Vrushali Harane", "Prefect", "+91 9937041658"),
              ],
            )
          ],
        ),
